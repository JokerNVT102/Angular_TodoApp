...
export class TodoService {
  ...
  fetchFormLocalStrorage() {
    this.todos =
      this.storageService.getValue<Todo[]>(TodoService.TodoStorageKey) || [];
    this.filteredTodos = [...this.todos.map((todo) => ({ ...todo }))]; //su dung lodash
  ...
  changeTodoStatus(id: number, isCompleted: boolean) {
    //ham findIndex tim trong arr todos co id nao trung voi id nhan tu todo-item
